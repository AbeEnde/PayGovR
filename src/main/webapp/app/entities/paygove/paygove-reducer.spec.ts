...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './paygove.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYGOVE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYGOVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYGOVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYGOVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYGOVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYGOVE actions', async () => {
      const expectedActions = [
        {
